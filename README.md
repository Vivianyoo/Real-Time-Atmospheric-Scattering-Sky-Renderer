...
It renders a procedural sky around the camera using a sky cube and shader-based atmosphere parameters.

The application allows the user to interactively adjust the sun elevation, atmospheric density, sampling step count, sun size, and aerosol scattering coefficient while observing the result in real time.
...
- Shader-based atmosphere rendering
- Interactive first-person camera movement
- Mouse-look camera control
- Real-time adjustment of atmospheric parameters
...
Recommended setting in Visual Studio:
